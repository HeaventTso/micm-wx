...
var storeContext = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__store_flyio_request__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(98);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  install: function install(Vue) {
    var iBox = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, __WEBPACK_IMPORTED_MODULE_2__utils__["a" /* default */], {
      http: __WEBPACK_IMPORTED_MODULE_1__store_flyio_request__["a" /* default */]
    });
...
var modulesContext = __webpack_require__(95);
var API = {};
var chunks = modulesContext.keys().reduce(function (modules, key) {
  if (key !== './index.js') {
    API = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, API, modulesContext(key).default);
  }
  return API;
}, {});
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, chunks));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_4e993979_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_card_vue__ = __webpack_require__(113);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_4e993979_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_lib_selector_type_template_index_0_card_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4e993979", Component.options)
  } else {
    hotAPI.reload("data-v-4e993979", Component.options)
  }
...
var actions = {
  ...
  getProvince: function getProvince(_ref3) {
    var commit = _ref3.commit;
    var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    return __WEBPACK_IMPORTED_MODULE_0_vue___default.a.iBox.http('globalUrl.getProvince', params)({ method: 'get' });
  }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interceptors__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__apiUrl__ = __webpack_require__(44);
...
// 异常情况的错误处理
var errorFunction = function errorFunction(reqConfig, err) {
  // 如果有异常需要提示
  if (!reqConfig.errorAction && reqConfig.isErrorDefaultTip) {
    setTimeout(function () {
      __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].resError.tipShow();
    }, 0);
  }
  throw err;
};

var promises = []; // 接收接口请求的promise数组
var loadingTimer = []; // loading的定时器
...
var handleRequest = function handleRequest() {
  ...
  var _url = __WEBPACK_IMPORTED_MODULE_3__apiUrl__["default"][url] || '';
  return function () {
    var flyConfig = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var defaultTipConfig = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    var flyio = __WEBPACK_IMPORTED_MODULE_2__interceptors__["a" /* default */].request(_url, data, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].flyConfig, flyConfig));
    var tipConfig = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].reqConfig, defaultTipConfig);

    // 开启loading
    clearTimeout(loadingTimer); // 多个接口时需要清除上一个loading
    loadingTimer = setTimeout(function () {
      tipConfig.isLoading && __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].loading.loadingShow();
    }, __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].loading.limitTime);

    // 计算当前的promise是否全部加载完成
    promises.push(flyio.catch(function (e) {}));
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(promises).then(function (data) {
    ...
    return flyio.then(function (res) {
      // 成功返回
      if (res[__WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].resSuccess.key] === __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].resSuccess.value) {
        tipConfig.isLoading && __WEBPACK_IMPORTED_MODULE_4__config__["a" /* default */].loading.loadingHide(); // 当promise全部加载完成则隐藏loading
        return res;
      } else {
...
/* harmony default export */ __webpack_exports__["a"] = (handleRequest);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_flyio__ = __webpack_require__(94);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_flyio___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_flyio__);

var request = new __WEBPACK_IMPORTED_MODULE_0_flyio___default.a();
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys__ = __webpack_require__(99);
...
var validator = {
   ...
   * @returns {boolean}
   */
  executeExp: function executeExp(pattern, strValue) {
   ...
   * @returns {boolean}
   */
  isEmpty: function isEmpty(strValue) {
   ...
   * @returns {boolean}
   */
  isNotEmpty: function isNotEmpty(strValue) {
   ...
   * @returns {boolean}
   */
  isCnAndEn: function isCnAndEn(strValue) {
   ...
   * @returns {boolean}
   */
  isCnAndEnAndNum: function isCnAndEnAndNum(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isUserName: function isUserName(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isAuthCode: function isAuthCode(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isMobile: function isMobile(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isTelAndMobile: function isTelAndMobile(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isPassword: function isPassword(strValue) {
    if (this.isEmpty(strValue)) return false;
   ...
   * @returns {boolean}
   */
  isLenRange: function isLenRange(strValue, lenArr) {
   ...
   * @returns {boolean}
   */
  isNumRange: function isNumRange(numValue, numArr) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-4e993979", esExports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index_test_tabbar__ = __webpack_require__(103);
...
}, __WEBPACK_IMPORTED_MODULE_2__pages_index_test_tabbar__["a" /* default */]));

app.$mount();

/* harmony default export */ __webpack_exports__["default"] = ({
  "navigationBarTitleText": "taps_tabbar例子",
  "usingComponents": {
    "i-tab-bar": "../../iView-weapp/tab-bar/index",
    "i-tab-bar-item": "../../iView-weapp/tab-bar-item/index"
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index_index__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_ibox__ = __webpack_require__(8);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
  store: __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */]
}, __WEBPACK_IMPORTED_MODULE_2__pages_index_index__["a" /* default */]));

app.$mount();

/* harmony default export */ __webpack_exports__["default"] = ({
  "navigationBarTitleText": "投资信息",
  "usingComponents": {
    "i-tabs": "../../iView-weapp/tabs/index",
    "i-tab": "../../iView-weapp/tab/index",
    "i-row": "../../iView-weapp/row/index",
    "i-col": "../../iView-weapp/col/index",
    "i-icon": "../../iView-weapp/icon/index",
    "i-steps": "../../iView-weapp/steps/index",
    "i-step": "../../iView-weapp/step/index",
    "i-button": "../../iView-weapp/button/index",
    "i-sticky": "../../iView-weapp/sticky/index",
    "i-sticky-item": "../../iView-weapp/sticky-item/index",
    "i-tab-bar": "../../iView-weapp/tab-bar/index",
    "i-tab-bar-item": "../../iView-weapp/tab-bar-item/index"
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index_taps_demo__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_ibox__ = __webpack_require__(8);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
  store: __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */]
}, __WEBPACK_IMPORTED_MODULE_2__pages_index_taps_demo__["a" /* default */]));

app.$mount();

/* harmony default export */ __webpack_exports__["default"] = ({
  "navigationBarTitleText": "taps例子",
  "usingComponents": {
    "i-tabs": "../../iView-weapp/tabs/index",
    "i-tab": "../../iView-weapp/tab/index"
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_index_test_demo__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_ibox__ = __webpack_require__(8);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
  store: __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */]
}, __WEBPACK_IMPORTED_MODULE_2__pages_index_test_demo__["a" /* default */]));

app.$mount();

/* harmony default export */ __webpack_exports__["default"] = ({
  "navigationBarTitleText": "iview例子",
  "usingComponents": {
    "i-sticky": "../../iView-weapp/sticky/index",
    "i-sticky-item": "../../iView-weapp/sticky-item/index"
  }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_counter_index__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_ibox__ = __webpack_require__(8);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
  store: __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */]
}, __WEBPACK_IMPORTED_MODULE_2__pages_counter_index__["a" /* default */]));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_logs_index__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__plugins_ibox__ = __webpack_require__(8);
...
var app = new __WEBPACK_IMPORTED_MODULE_1_vue___default.a(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
  store: __WEBPACK_IMPORTED_MODULE_3__store__["a" /* default */]
}, __WEBPACK_IMPORTED_MODULE_2__pages_logs_index__["a" /* default */]));
